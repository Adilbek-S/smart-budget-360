...
export const DEPARTMENTS: Department[] = [
  { id: "techdev", name: "Департамент разработки и развития технологий", short: "Разработка" },
  { id: "it", name: "Департамент информационных технологий", short: "ИТ" },
  { id: "opscontrol", name: "Департамент операционного контроля", short: "Опер. контроль" },
  { id: "cards", name: "Департамент карточного процессинга", short: "Карты" },
  {
    id: "antifraud",
    name: "Департамент по противодействию мошенническим действиям — Антифрод-центр",
    short: "Антифрод",
  },
  { id: "payments", name: "Департамент развития платёжных систем", short: "Платежи" },
  { id: "digitaltenge", name: "Департамент системы Цифрового тенге", short: "Циф. тенге" },
  {
    id: "orgdev",
    name: "Департамент по организационному развитию и трансформации",
    short: "Оргразвитие",
  },
  { id: "fin", name: "Финансовый департамент", short: "Финансы" },
  { id: "sec", name: "Управление информационной безопасности", short: "ИБ" },
  {
    id: "architecture",
    name: "Управление архитектуры решений и контроля качества",
    short: "Архитектура",
  },
  { id: "astana", name: "Представительство в г. Астана", short: "Астана" },
