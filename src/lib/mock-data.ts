...
export const DEPARTMENTS: Department[] = [
  { id: "it", name: "Департамент информационных технологий", short: "ИТ" },
  { id: "fin", name: "Департамент финансов", short: "Финансы" },
  { id: "product", name: "Департамент развития продуктов", short: "Продукты" },
  { id: "ops", name: "Департамент эксплуатации", short: "Эксплуатация" },
  {
    id: "sec",
    name: "Департамент информационной безопасности",
    short: "ИБ",
  },
  { id: "adm", name: "Административный департамент", short: "Администрация" },
];
...
const CATEGORY_DISTRIBUTION: Record<"org" | DepartmentId, Record<ExpenseCategoryId, number>> = {
  ...
  product: { staff: 48, it_infra: 12, software: 22, services: 10, travel: 5, other: 3 },
  ops: { staff: 40, it_infra: 28, software: 8, services: 16, travel: 4, other: 4 },
...
const DEVIATIONS_2026: DeviationRow[] = [
  ...
  { id: "d2", year: 2026, department: "product", article: "Командировочные расходы", plan: 42_000_000, fact: 55_000_000, status: "warning" },
  { id: "d3", year: 2026, department: "ops", article: "Аренда серверных мощностей", plan: 260_000_000, fact: 312_000_000, status: "warning" },
  ...
  { id: "d8", year: 2026, department: "product", article: "Маркетинговые исследования", plan: 30_000_000, fact: 33_500_000, status: "normal" },
  { id: "d9", year: 2026, department: "ops", article: "Техническое обслуживание оборудования", plan: 96_000_000, fact: 94_000_000, status: "normal" },
...
const DEVIATIONS_2025: DeviationRow[] = [
  ...
  { id: "d13", year: 2025, department: "ops", article: "Аренда оборудования", plan: 220_000_000, fact: 265_000_000, status: "critical" },
  { id: "d14", year: 2025, department: "adm", article: "Хозяйственные расходы", plan: 48_000_000, fact: 50_000_000, status: "normal" },
  { id: "d15", year: 2025, department: "product", article: "Исследования рынка", plan: 26_000_000, fact: 19_000_000, status: "warning" },
];
...
export const HISTORY_ENTRIES: HistoryEntry[] = [
  ...
  { id: "h4", date: "2026-06-14", author: "Бюджетный комитет", department: "product", action: "Отклонение заявки", details: "Отклонена заявка на командировку в связи с превышением лимита" },
  ...
  { id: "h6", date: "2026-05-30", author: "Ержан Тулегенов", department: "ops", action: "Отклонение заявки", details: "Отклонена заявка на закупку резервных серверов — требуется пересмотр ТЗ" },
...
export const PRODUCTS: Product[] = [
  { id: "mobile_bank", name: "Мобильное приложение SmartBank", stage: "existing", department: "product" },
  { id: "corp_internet_bank", name: "Интернет-банкинг для юридических лиц", stage: "existing", department: "product" },
  { id: "smart_pay", name: "Платёжный шлюз SmartPay", stage: "new", department: "it" },
  { id: "fast_payments", name: "Система быстрых платежей", stage: "new", department: "it" },
  { id: "crm", name: "Корпоративная CRM-система", stage: "existing", department: "it" },
  { id: "smart_bonus", name: "Программа лояльности SmartBonus", stage: "new", department: "product" },
  { id: "online_lending", name: "Сервис онлайн-кредитования", stage: "existing", department: "product" },
  { id: "risk_monitoring", name: "Система риск-мониторинга", stage: "existing", department: "sec" },
  { id: "contact_center", name: "Единый контакт-центр", stage: "existing", department: "ops" },
  { id: "edo", name: "Электронный документооборот", stage: "existing", department: "adm" },
  { id: "acquiring", name: "Эквайринг для бизнеса", stage: "existing", department: "product" },
  { id: "deposits", name: "Депозитные продукты онлайн", stage: "existing", department: "fin" },
  { id: "fx", name: "Валютно-обменные операции", stage: "existing", department: "fin" },
...
export const BUDGET_LINES: BudgetLine[] = [
  {
    ...
    relatedDepartments: ["product", "ops"],
    productId: "crm",
    status: "approved",
    risk: "none",
    author: "Динара Ахметова",
  ...
  },
  {
    ...
    relatedDepartments: ["ops"],
    productId: "contact_center",
    status: "approved",
    risk: "none",
    author: "Динара Ахметова",
  ...
  },
  {
    ...
    relatedDepartments: ["product", "sec"],
    productId: "smart_pay",
    status: "approved",
    risk: "none",
    author: "Динара Ахметова",
